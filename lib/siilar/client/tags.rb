  ...
  class Client
    module Tags
      ...
      def tag_collections(query = {})
        options = { query: query }
        response = client.get('tag-collections', options)
      ...
      def tag_collection(collection)
        response = client.get("tag-collections/#{collection}")
      ...
      def create_tag_collection(attributes = {})
        ...
        response = client.post('tag-collections', attributes)
      ...
      def edit_tag_collection(collection, attributes = {})
        response = client.patch("tag-collections/#{collection}", attributes)
      ...
      def delete_tag_collection(collection)
        client.delete("tag-collections/#{collection}")
      end
      ...
      def find_tags(query = {})
        options = { query: query }
        response = client.get('tags', options)
      ...
      def create_tag(attributes = {})
        ...
        response = client.post('tags', attributes)
      ...
      def edit_tag(tag, attributes = {})
        response = client.patch("tags/#{tag}", attributes)
