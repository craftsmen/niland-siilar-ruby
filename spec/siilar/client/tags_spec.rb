...
describe Siilar::Client, '.tags' do
  ...
  describe '#tag_collections' do
    before do
      stub_request(:get, %r[/2.0/tag-collections]).to_return(read_fixture('tags/list_collections/success.http'))
    end

    it 'builds the correct request' do
      subject.tag_collections

      expect(WebMock).to have_requested(:get, 'http://api.niland/2.0/tag-collections?key=key')
    end
  ...
  describe '#tag_collection' do
    before do
      stub_request(:get, %r[/2.0/tag-collections/.+]).to_return(read_fixture('tags/get_collection/success.http'))
    end
    ...
    it 'builds the correct request' do
      ...
      expect(WebMock).to have_requested(:get, 'http://api.niland/2.0/tag-collections/54d823e858172f11df4919d3?key=key')
    end
  ...
  describe '#create_tag_collection' do
    before do
      stub_request(:post, %r[/2.0/tag-collections]).to_return(read_fixture('tags/create_collection/created.http'))
    end
  ...
  describe '#edit_tag_collection' do
    before do
      stub_request(:patch, %r[/2.0/tag-collections/54d823e858172f11df4919d8]).to_return(read_fixture('tags/update_collection/success.http'))
    end
  ...
  describe '#find_tags' do
    before do
      stub_request(:get, %r[/2.0/tags]).to_return(read_fixture('tags/list/success.http'))
    end
    ...
    it 'builds the correct request' do
      ...
      expect(WebMock).to have_requested(:get, 'http://api.niland/2.0/tags?key=key&query=pia')
    end
  ...
  describe '#tag' do
    before do
      stub_request(:get, %r[/2.0/tags/.+]).to_return(read_fixture('tags/get/success.http'))
    end
    ...
    it 'builds the correct request' do
      ...
      expect(WebMock).to have_requested(:get, 'http://api.niland/2.0/tags/5000?key=key')
    end
  ...
  describe '#create_tag' do
    before do
      stub_request(:post, %r[/2.0/tags]).to_return(read_fixture('tags/create/created.http'))
    end
    ...
    it 'builds the correct request' do
      ...
      expect(WebMock).to have_requested(:post, 'http://api.niland/2.0/tags?key=key')
                          .with(body: attributes)
    end
  ...
  describe '#edit_tag' do
    before do
      stub_request(:patch, %r[/2.0/tags/5000]).to_return(read_fixture('tags/update/success.http'))
    end

    it 'builds the correct request' do
      subject.edit_tag(5000, { title: 'Updated' })

      expect(WebMock).to have_requested(:patch, 'http://api.niland/2.0/tags/5000?key=key')
  ...
  describe '#delete_tag' do
    before do
      stub_request(:delete, %r[/2.0/tags/5000]).to_return(read_fixture("tags/delete/success.http"))
    end

    it 'builds the correct request' do
      subject.delete_tag(5000)

      expect(WebMock).to have_requested(:delete, 'http://api.niland/2.0/tags/5000?key=key')
    end
    ...
    it 'supports HTTP 204' do
      stub_request(:delete, %r[/2.0/tags/5000]).to_return(read_fixture('tags/delete/success-204.http'))
    ...
    context 'when something does not exist' do
      it 'raises NotFoundError' do
        stub_request(:delete, %r[/2.0/tags/5000]).to_return(read_fixture('tags/notfound.http'))
